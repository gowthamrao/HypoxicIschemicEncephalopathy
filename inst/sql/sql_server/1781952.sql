...
( 
  select concept_id from @vocabulary_database_schema.CONCEPT where concept_id in (42738640,4218726,4062748,4203429,46257681,44816372,42742501,44816371,42742500,4296384)
...
WHERE YEAR(C.condition_start_date) - P.year_of_birth < 1
