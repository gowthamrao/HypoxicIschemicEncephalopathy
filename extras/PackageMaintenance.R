...
#
# This file is part of HypoxicIschemicEncephalopathy
#
...
styler::style_pkg()
OhdsiRTools::checkUsagePackage("HypoxicIschemicEncephalopathy")
...
OhdsiRTools::createRenvLockFile(
  rootPackage = "HypoxicIschemicEncephalopathy",
  mode = "description",
