...
version <- "v0.1.0"
name <- "Hypoxic Ischemic Encephalopathy - an OHDSI network study"
packageName <- "HypoxicIschemicEncephalopathy"
...
description <- "Cohort diagnostics on Hypoxic Ischemic Encephalopathy"
...
cohortIds <- c(1781956, 1781968, 1781973, 1781968,
               ...
               1781972, 1781966, 1781974, 1781975,
               1781976)
